"""
FourierBlock: A Fourier-based block for sequence modeling.
"""
import torch
...
class FourierBlock(FourierAttentionBase):
    def __init__(self, d_model, n_heads, seq_len=96, modes=64, dropout=0.1):
