...
class MSELoss(nn.Module, LossLike):
    """
...
class MAELoss(nn.Module, LossLike):
    """
...
class CrossEntropyLoss(nn.Module, LossLike):
    """
...
class HuberLoss(nn.Module, LossLike):
    """
...
class NegativeLogLikelihood(nn.Module, LossLike):
    """
...
class QuantileLoss(nn.Module, LossLike):
    """
...
class MultiTaskLoss(nn.Module, LossLike):
    """
    Multi-task loss combining multiple loss functions
    """
    
    def __init__(self, config: LossConfig, task_losses: Dict[str, LossLike], task_weights: Optional[Dict[str, float]] = None):
        self.config = config
...
class FocalLoss(nn.Module, LossLike):
    """
