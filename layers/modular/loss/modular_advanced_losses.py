...
from ..core.interfaces import LossLike
import torch.nn as nn
...
class BayesianMSELoss(nn.Module, LossLike):
    ...
    def __init__(self, config: Union[BayesianLossConfig, Dict[str, Any]]):
        ...
        try:
            from .bayesian_loss import BayesianLoss
            import torch.nn as nn
...
class BayesianMAELoss(nn.Module, LossLike):
...
class AdaptiveStructuralLoss(nn.Module, LossLike):
    ...
    def __init__(self, config: Union[AdaptiveLossConfig, Dict[str, Any]]):
        ...
        try:
            from .adaptive_bayesian_losses import AdaptiveAutoformerLoss
...
class FrequencyAwareLoss(nn.Module, LossLike):
    ...
    def __init__(self, config: Union[FrequencyLossConfig, Dict[str, Any]]):
        ...
        try:
            from .adaptive_bayesian_losses import FrequencyAwareLoss as FALoss
...
class PatchStructuralLoss(nn.Module, LossLike):
    ...
    def __init__(self, config: Union[StructuralLossConfig, Dict[str, Any]]):
        ...
        try:
            from .advanced_losses import PSLoss
...
class DTWAlignmentLoss(nn.Module, LossLike):
    ...
    def __init__(self, config: Union[LossConfig, Dict[str, Any]]):
        ...
        try:
            from .adaptive_bayesian_losses import DTWAlignmentLoss as DTWLoss  # Assuming alignment as the DTW implementation
...
class MultiScaleTrendLoss(nn.Module, LossLike):
    ...
    def __init__(self, config: Union[LossConfig, Dict[str, Any]]):
        ...
        try:
            from .adaptive_bayesian_losses import MultiScaleTrendLoss as MultiScaleTrendAwareLoss  # Adjusted name
...
class BayesianQuantileLoss(nn.Module, LossLike):
    ...
    def __init__(self, config: Union[BayesianLossConfig, Dict[str, Any]]):
        ...
        try:
            from .bayesian_loss import BayesianQuantileLoss as BQL
