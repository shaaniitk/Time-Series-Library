"""Modular Bi-directional attention fusion processor (replaces utils version)."""
...
class BiDirectionalFusionProcessor(nn.Module):
    ...
    Returns enriched context of shape [B, L, d_model].
    """
    ...
    def forward(self, target_repr: torch.Tensor, covariate_repr: torch.Tensor):
