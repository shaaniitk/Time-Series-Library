...
class CovariateEmbedding(BaseEmbedding):
    """
    Embedding for covariate features including categorical and numerical covariates.
    
    Handles multiple categorical features with individual embeddings and numerical features
    with linear projection, combining them into a unified embedding space.
    """
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        return {
            ...
            'components': {
                ...
                'value': self.use_value,
                'covariate': self.use_covariate
            },
