...
def quick_bayesian_sanity_test():
    ...
    print("🚀 Quick Bayesian Sanity Test")
    print("=" * 40)
    print("Parameters:")
    ...
    try:
        ...
        if result.returncode == 0:
            print("✅ Bayesian model sanity test PASSED")
            ...
            print("❌ Bayesian model sanity test FAILED")
...
if __name__ == "__main__":
    ...
    if success:
        print("\n🎉 Bayesian model is working correctly!")
        print("Ready for full-scale training.")
    else:
        print("\n⚠️ Sanity test failed - check the logs above.")
