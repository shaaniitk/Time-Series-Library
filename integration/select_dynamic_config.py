...
def generate_dynamic_configs(data_analysis, mode, complexity):
    ...
    template_config = f"../config/config_enhanced_autoformer_{mode}_{complexity}.yaml"
    ...
    try:
        output_config = f"../config/config_enhanced_autoformer_{mode}_{complexity}_dynamic.yaml"
